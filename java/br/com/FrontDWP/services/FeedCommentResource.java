...
public FeedComment buscarFeedCommentById(Long Id){
	...
	try {
		...
		WebResource webResource = client
		   .resource(ServicePath.HOST+"/api/private/feedcomment/findbyfeedCommentId/"+Id);
	...
	return  gson.fromJson(json, new TypeToken<FeedComment>(){}.getType());	
